...
import { ProofOfPossession } from "../src/proof"
...
const tests: testSig[] = [
	...
	{
        name: "should fail verification due to namespace mismatch as test signatures use file namespace",
        sig: "",
        data: "1765696780805.SHA256:4A33TPWJZ8trpUhhn0mpK1wISFzVGhWlWShoGylLUbg",
        from: 1765696790000,
        want: false
    ...
    {
        name: "should error due to timestamp in future",
        sig: "",
        data: "1765696780805.SHA256:4A33TPWJZ8trpUhhn0mpK1wISFzVGhWlWShoGylLUbg",
        from: 1765696000000,
